...
const rounds = [
  ...
  },
  {
    ...
    expected: ["Angela Merkel", "Reichstag"],
  },
];
...
function downloadCSV() {
  ...
  userResponses.forEach((response, index) => {
    csvContent +=
      index + 1 + "," + response.response + "," + response.correct + "\n";
  });
